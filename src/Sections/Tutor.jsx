  ...
  return (
    <div className="mt-8">
      ...
      <div className="mt-16 mb-14 text-center flex flex-col gap-7 items-center">
        <img src="/university.svg" alt="university" className="w-11 h-11" />
      ...
      <div className="mt-14 mb-14 text-center flex flex-col gap-8 items-center">
        <img src="/showcase.svg" alt="university" className="w-11 h-11" />
      ...
      <img src="/tutor.svg" alt="tutor" className="m-auto" />
    </div>
  )
}
